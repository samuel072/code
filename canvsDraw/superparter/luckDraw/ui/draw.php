...
<div id="nothing">
    <div class="app-wrapper">
		...
		<img id="robot" src="<?php echo $drawList['imageUrl']; ?>" />
...
<script type = "text/javascript">
                ...
                if(data.prizeId != 3){
            		var html = "<div class='success'>"+
                    				"<div class='info' id='info'>"+
                    			         	"<a href='/superparter/luckDraw/toSaveInfo.php?drawName=<?php echo $drawList['rid']; ?>' class='addBtn'>填写信息</a>"+
                    				"</div>"+
                    			"</div>";
                                $("#nothing").append(html);
                } else {
                    if(data.drawNum < 2){
                		var html = "<div class='fail'>"+
                        				"<div class='failInfo' id='failInfo'>"+
                        					"<em id='close' onclick='closeAgain();'></em>"+
                                            "<a class='againBtn' onclick='again();' id='againBtn'><img src='/superparter/images/failBtn.png'/></a>"+
                                        "</div>"+
                        			"</div>"+
						...
						var html = "<div class='newSuccess'>" +
										"<div class='newSuc' id='newSuc'>"+
											"<em id='close' onclick='closeAgain();'></em>"+
											"<a href='http://hhr360.com/app' class='loadBtn failBt' id='download'>下载超级合伙人APP</a>"+
										"<div>"+
									"<div>";
						$("#nothing").append(html);
						downloadCss();
                ...
                if(data.drawNum < 2){
                    var html = "<div class='fail'>"+
                    				"<div class='failInfo' id='failInfo'>"+
                    					"<em id='close' onclick='closeAgain();'></em>";
                                        if(data.drawNum < 2){
                    					   html += "<a class='againBtn' onclick='again();' id='againBtn'><img src='/superparter/images/failBtn.png'/></a>";
                                        }
                    		html += "</div>"+
                    			"</div>"+
                                "<div class='againLoty'></div>";
    ...
    function againBtn(){
        var p0=document.getElementById('againBtn')
        p0.style.width=(document.body.clientWidth*0.8)+"px";
        p0.style.left=(document.body.clientWidth*0.1)+"px";
    }
