...
<div id="cell-div">
  ...
  <input id="cell-number" name="cell-number" type="number" value="" 
  onfocus="mobile_onfocus()" 
  onblur="mobile_onblur()" />
  <div id="cell-number-back" name="cell-number-back" type="text" value="输入手机号" style="position:absolute;z-index: -1;"><td>输入手机号</td></div>
  <img class="mobile_icon_line" src="../images/mobile_num_line_07.png" style="float:left;margin-top:1%;width:100%"></img>
</div>
</div>
<img onclick="if(checkMobile()) formLogin.submit(); else alert('手机号输入错误,请重新输入！')" class="get_hongbao" src="../images/qianbao_lingqu.png" style=""></img>
